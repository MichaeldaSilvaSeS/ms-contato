...
@FeignClient(name="phoneApi",url="http://api.citybik.es",path="/v2",fallback=BikeAPIClient.BikeAPIClientFallback.class)
public interface BikeAPIClient {
	...
	@Component
	public static class BikeAPIClientFallback implements BikeAPIClient{

		@Override
		public String getBikes(@RequestParam("network_id")String network_id) {
			return "";
		}
